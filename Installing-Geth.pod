...
<ul id="markdown-toc">
  <li><a href="#updating-geth" id="markdown-toc-updating-geth">Updating Geth</a></li>
  ...
  <li><a href="#build-go-ethereum-from-source-code" id="markdown-toc-build-go-ethereum-from-source-code">Build go-ethereum from source code</a>    <ul>
...
<p>The easiest way to install go-ethereum is to use our Homebrew tap. If you don’t have
...
data volume as the client’s data directory (located at <code class="language-plaintext highlighter-rouge">/root/.ethereum</code> inside the
