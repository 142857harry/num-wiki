...
If you just want to run ethereum, use the regular <a href="./Installing-Geth">Installation Instructions</a>.</strong></p>
...
consult our <a href="./Cross-Compiling-Geth">cross compilation guide</a>.</p>
