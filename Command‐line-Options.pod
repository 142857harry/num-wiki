    <div class="col-md-9" id="content">
      ...
      <div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>$ gpod --help
NAME:
   gpod - the go-pod command line interface

   Copyright 2013-2021 The go-pod Authors

USAGE:
   gpod [options] [command] [command options] [arguments...]
...
COMMANDS:
   ...
   wallet                             Manage POD presale wallets
   help, h                            Shows a list of commands or help for one command

POD OPTIONS:
  --config value                      TOML configuration file
  --datadir value                     Data directory for the databases and keystore (default: "~/.pod")
  ...
  --podstats value                    Reporting URL of a podstats service (nodename:secret@host:port)
...
API AND CONSOLE OPTIONS:
  ...
  --rpc.gascap value                  Sets a cap on gas that can be used in pod_call/estimateGas (0=infinite) (default: 50000000)
  --rpc.txfeecap value                Sets a cap on transaction fee (in pod) that can be sent via the RPC APIs (0 = no cap) (default: 1)
...
MINER OPTIONS:
  ...
  --miner.poderbase value             Public address for block mining rewards (default = first account) (default: "0")
...
LOGGING AND DEBUGGING OPTIONS:
  ...
  --vmodule value                     Per-module verbosity: comma-separated list of &lt;pattern&gt;=&lt;level&gt; (e.g. pod/*=5,p2p=4)
...
METRICS AND STATS OPTIONS:
  ...
  --metrics.influxdb.database value   InfluxDB database name to push reported metrics to (default: "gpod")
...
MISC OPTIONS:
  ...
  --help, -h                          show help
  --catalyst                          Catalyst mode (pod2 integration testing)
