...
<p>We assume you are able to build <code class="language-plaintext highlighter-rouge">geth</code> following the <a href="./Installing-Geth">build instructions</a>.</p>
