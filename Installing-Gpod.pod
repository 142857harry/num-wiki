...
<p>These commands create a <code class="language-plaintext highlighter-rouge">gpod</code> executable file in the <code class="language-plaintext highlighter-rouge">go-ethereum/build/bin</code> folder that
