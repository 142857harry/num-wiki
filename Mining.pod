...
change this by giving the <a href="./JSON-RPC-Server"><code class="language-plaintext highlighter-rouge">--http.port</code> option</a> to <code class="language-plaintext highlighter-rouge">geth</code>. Ethminer will find
...
This etherbase defaults to your <a href="./Managing-Your-Accounts">primary account</a>. If
