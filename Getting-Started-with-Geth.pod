...
<p>This guide uses <a href="./#clef">Clef</a>, which is our preferred tool for signing transactions with Geth,
...
These include the main Ethereum network, <a href="./Private-Network-Tutorial">a private network</a> you create,
...
<a href="./#clef">Geth RPC interface</a> (see below), and sets Clef as the transaction signer.</p>
